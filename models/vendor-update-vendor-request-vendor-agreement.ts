 ...
 * 
 * @export
 * @interface VendorUpdateVendorRequestVendorAgreement
 */
export interface VendorUpdateVendorRequestVendorAgreement {
    /**
     * 
     * @type {number}
     * @memberof VendorUpdateVendorRequestVendorAgreement
     */
