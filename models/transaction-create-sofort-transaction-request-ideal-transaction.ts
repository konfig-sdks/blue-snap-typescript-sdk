 ...
 * 
 * @export
 * @interface TransactionCreateSofortTransactionRequestIdealTransaction
 */
export interface TransactionCreateSofortTransactionRequestIdealTransaction {
    /**
     * 
     * @type {string}
     * @memberof TransactionCreateSofortTransactionRequestIdealTransaction
     */
    'returnUrl'?: string;
}
