...
import { ShopperCreateVaultedShopperRequestPaymentSources } from './shopper-create-vaulted-shopper-request-payment-sources';

/**
 * 
 * @export
 * @interface ShopperCreateVaultedShopperRequest
 */
export interface ShopperCreateVaultedShopperRequest {
    /**
     * 
     * @type {ShopperCreateVaultedShopperRequestPaymentSources}
     * @memberof ShopperCreateVaultedShopperRequest
     */
