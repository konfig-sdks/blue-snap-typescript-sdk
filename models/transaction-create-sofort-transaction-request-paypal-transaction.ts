 ...
 * 
 * @export
 * @interface TransactionCreateSofortTransactionRequestPaypalTransaction
 */
export interface TransactionCreateSofortTransactionRequestPaypalTransaction {
    /**
     * 
     * @type {string}
     * @memberof TransactionCreateSofortTransactionRequestPaypalTransaction
     */
    'cancelUrl'?: string;
    /**
     * 
