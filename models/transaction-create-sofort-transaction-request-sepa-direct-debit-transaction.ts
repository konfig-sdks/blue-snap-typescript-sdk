 ...
 * 
 * @export
 * @interface TransactionCreateSofortTransactionRequestSepaDirectDebitTransaction
 */
export interface TransactionCreateSofortTransactionRequestSepaDirectDebitTransaction {
    /**
     * 
     * @type {string}
     * @memberof TransactionCreateSofortTransactionRequestSepaDirectDebitTransaction
     */
    'iban'?: string;
}
