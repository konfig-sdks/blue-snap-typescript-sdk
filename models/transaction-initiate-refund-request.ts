...
import { TransactionInitiateRefundRequestTransactionMetaData } from './transaction-initiate-refund-request-transaction-meta-data';

/**
 * 
 * @export
 * @interface TransactionInitiateRefundRequest
 */
export interface TransactionInitiateRefundRequest {
    /**
     * 
     * @type {string}
     * @memberof TransactionInitiateRefundRequest
     */
    'reason'?: string;
    /**
     * 
    ...
    /**
     * 
     * @type {TransactionInitiateRefundRequestTransactionMetaData}
     * @memberof TransactionInitiateRefundRequest
     */
