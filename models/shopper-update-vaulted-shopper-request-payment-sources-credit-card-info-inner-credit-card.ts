 ...
 * 
 * @export
 * @interface ShopperUpdateVaultedShopperRequestPaymentSourcesCreditCardInfoInnerCreditCard
 */
export interface ShopperUpdateVaultedShopperRequestPaymentSourcesCreditCardInfoInnerCreditCard {
    /**
     * 
     * @type {number}
     * @memberof ShopperUpdateVaultedShopperRequestPaymentSourcesCreditCardInfoInnerCreditCard
     */
