 ...
 * empty object
 * @export
 * @interface TransactionCreateSofortTransactionRequestLocalBankTransferTransaction
 */
export interface TransactionCreateSofortTransactionRequestLocalBankTransferTransaction {
    /**
     * 
     * @type {string}
     * @memberof TransactionCreateSofortTransactionRequestLocalBankTransferTransaction
     */
    '{}'?: string;
}
