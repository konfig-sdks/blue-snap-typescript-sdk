 ...
 * 
 * @export
 * @interface SubscriptionCreateMerchantManagedChargeRequest
 */
export interface SubscriptionCreateMerchantManagedChargeRequest {
    /**
     * 
     * @type {number}
     * @memberof SubscriptionCreateMerchantManagedChargeRequest
     */
    'amount'?: number;
    /**
     * 
