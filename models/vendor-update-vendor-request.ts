...
import { VendorUpdateVendorRequestPayoutInfoInner } from './vendor-update-vendor-request-payout-info-inner';
import { VendorUpdateVendorRequestVendorAgreement } from './vendor-update-vendor-request-vendor-agreement';
import { VendorUpdateVendorRequestVendorPrincipal } from './vendor-update-vendor-request-vendor-principal';

/**
 * 
 * @export
 * @interface VendorUpdateVendorRequest
 */
export interface VendorUpdateVendorRequest {
    /**
     * 
     * @type {string}
     * @memberof VendorUpdateVendorRequest
     */
    'email'?: string;
    /**
     * 
    ...
    /**
     * 
     * @type {VendorUpdateVendorRequestVendorPrincipal}
     * @memberof VendorUpdateVendorRequest
     */
    'vendorPrincipal'?: VendorUpdateVendorRequestVendorPrincipal;
    /**
     * 
     * @type {Array<VendorUpdateVendorRequestPayoutInfoInner>}
     * @memberof VendorUpdateVendorRequest
     */
    'payoutInfo'?: Array<VendorUpdateVendorRequestPayoutInfoInner>;
    /**
     * 
     * @type {VendorUpdateVendorRequestVendorAgreement}
     * @memberof VendorUpdateVendorRequest
     */
