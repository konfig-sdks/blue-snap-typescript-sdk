 ...
 * 
 * @export
 * @interface SubscriptionCreateMerchantManagedSubscriptionRequestPayerInfo
 */
export interface SubscriptionCreateMerchantManagedSubscriptionRequestPayerInfo {
    /**
     * 
     * @type {string}
     * @memberof SubscriptionCreateMerchantManagedSubscriptionRequestPayerInfo
     */
    'firstName'?: string;
    /**
     * 
