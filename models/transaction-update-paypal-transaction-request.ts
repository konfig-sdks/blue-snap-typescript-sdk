...
import { TransactionUpdatePaypalTransactionRequestPaypalTransaction } from './transaction-update-paypal-transaction-request-paypal-transaction';

/**
 * 
 * @export
 * @interface TransactionUpdatePaypalTransactionRequest
 */
export interface TransactionUpdatePaypalTransactionRequest {
    /**
     * 
     * @type {number}
     * @memberof TransactionUpdatePaypalTransactionRequest
     */
    'amount'?: number;
    /**
     * 
    ...
    /**
     * 
     * @type {TransactionUpdatePaypalTransactionRequestPaypalTransaction}
     * @memberof TransactionUpdatePaypalTransactionRequest
     */
