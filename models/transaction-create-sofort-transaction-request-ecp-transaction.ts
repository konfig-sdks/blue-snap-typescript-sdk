 ...
 * 
 * @export
 * @interface TransactionCreateSofortTransactionRequestEcpTransaction
 */
export interface TransactionCreateSofortTransactionRequestEcpTransaction {
    /**
     * 
     * @type {string}
     * @memberof TransactionCreateSofortTransactionRequestEcpTransaction
     */
