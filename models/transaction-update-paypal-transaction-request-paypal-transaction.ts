 ...
 * 
 * @export
 * @interface TransactionUpdatePaypalTransactionRequestPaypalTransaction
 */
export interface TransactionUpdatePaypalTransactionRequestPaypalTransaction {
    /**
     * 
     * @type {string}
     * @memberof TransactionUpdatePaypalTransactionRequestPaypalTransaction
     */
    'orderId'?: string;
    /**
     * 
