...
import { SubscriptionCreateNewRequestPaymentSourceCreditCardInfo } from './subscription-create-new-request-payment-source-credit-card-info';

/**
 * 
 * @export
 * @interface SubscriptionCreateNewRequestPaymentSource
 */
export interface SubscriptionCreateNewRequestPaymentSource {
    /**
     * 
     * @type {SubscriptionCreateNewRequestPaymentSourceCreditCardInfo}
     * @memberof SubscriptionCreateNewRequestPaymentSource
     */
    'creditCardInfo'?: SubscriptionCreateNewRequestPaymentSourceCreditCardInfo;
}
