 ...
 * 
 * @export
 * @interface TransactionCreateSofortTransactionRequestAcssDirectDebitTransaction
 */
export interface TransactionCreateSofortTransactionRequestAcssDirectDebitTransaction {
    /**
     * 
     * @type {string}
     * @memberof TransactionCreateSofortTransactionRequestAcssDirectDebitTransaction
     */
