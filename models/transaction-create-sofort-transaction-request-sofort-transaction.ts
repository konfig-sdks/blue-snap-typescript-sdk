 ...
 * 
 * @export
 * @interface TransactionCreateSofortTransactionRequestSofortTransaction
 */
export interface TransactionCreateSofortTransactionRequestSofortTransaction {
    /**
     * 
     * @type {string}
     * @memberof TransactionCreateSofortTransactionRequestSofortTransaction
     */
    'returnUrl'?: string;
}
