 ...
 * 
 * @export
 * @interface AuthorizationCreateTransactionRequestCardHolderInfo
 */
export interface AuthorizationCreateTransactionRequestCardHolderInfo {
    /**
     * 
     * @type {string}
     * @memberof AuthorizationCreateTransactionRequestCardHolderInfo
     */
    'firstName'?: string;
    /**
     * 
