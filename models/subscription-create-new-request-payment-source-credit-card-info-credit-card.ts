 ...
 * 
 * @export
 * @interface SubscriptionCreateNewRequestPaymentSourceCreditCardInfoCreditCard
 */
export interface SubscriptionCreateNewRequestPaymentSourceCreditCardInfoCreditCard {
    /**
     * 
     * @type {number}
     * @memberof SubscriptionCreateNewRequestPaymentSourceCreditCardInfoCreditCard
     */
