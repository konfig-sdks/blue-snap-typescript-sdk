 ...
 * 
 * @export
 * @interface VendorUpdateVendorRequestPayoutInfoInner
 */
export interface VendorUpdateVendorRequestPayoutInfoInner {
    /**
     * 
     * @type {string}
     * @memberof VendorUpdateVendorRequestPayoutInfoInner
     */
    'payoutType'?: string;
    /**
     * 
