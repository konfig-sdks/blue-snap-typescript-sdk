 ...
 * 
 * @export
 * @interface TransactionCreateSofortTransactionRequestPayerInfo
 */
export interface TransactionCreateSofortTransactionRequestPayerInfo {
    /**
     * 
     * @type {string}
     * @memberof TransactionCreateSofortTransactionRequestPayerInfo
     */
    'zip'?: string;
    /**
     * 
