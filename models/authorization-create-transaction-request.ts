...
import { AuthorizationCreateTransactionRequestCardHolderInfo } from './authorization-create-transaction-request-card-holder-info';
import { AuthorizationCreateTransactionRequestCreditCard } from './authorization-create-transaction-request-credit-card';

/**
 * 
 * @export
 * @interface AuthorizationCreateTransactionRequest
 */
export interface AuthorizationCreateTransactionRequest {
    /**
     * 
     * @type {number}
     * @memberof AuthorizationCreateTransactionRequest
     */
    'amount'?: number;
    /**
     * 
    ...
    /**
     * 
     * @type {AuthorizationCreateTransactionRequestCardHolderInfo}
     * @memberof AuthorizationCreateTransactionRequest
     */
    ...
    /**
     * 
     * @type {AuthorizationCreateTransactionRequestCreditCard}
     * @memberof AuthorizationCreateTransactionRequest
     */
