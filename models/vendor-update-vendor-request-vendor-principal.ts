 ...
 * 
 * @export
 * @interface VendorUpdateVendorRequestVendorPrincipal
 */
export interface VendorUpdateVendorRequestVendorPrincipal {
    /**
     * 
     * @type {string}
     * @memberof VendorUpdateVendorRequestVendorPrincipal
     */
    'firstName'?: string;
    /**
     * 
