 ...
 * 
 * @export
 * @interface AuthorizationCreateTransactionRequestCreditCard
 */
export interface AuthorizationCreateTransactionRequestCreditCard {
    /**
     * 
     * @type {number}
     * @memberof AuthorizationCreateTransactionRequestCreditCard
     */
