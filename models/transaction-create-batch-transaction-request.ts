...
import { TransactionCreateBatchTransactionRequestBatchTransaction } from './transaction-create-batch-transaction-request-batch-transaction';

/**
 * 
 * @export
 * @interface TransactionCreateBatchTransactionRequest
 */
export interface TransactionCreateBatchTransactionRequest {
    /**
     * 
     * @type {TransactionCreateBatchTransactionRequestBatchTransaction}
     * @memberof TransactionCreateBatchTransactionRequest
     */
