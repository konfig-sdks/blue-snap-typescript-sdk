...
import { ShopperUpdateVaultedShopperRequestPaymentSources } from './shopper-update-vaulted-shopper-request-payment-sources';

/**
 * 
 * @export
 * @interface ShopperUpdateVaultedShopperRequest
 */
export interface ShopperUpdateVaultedShopperRequest {
    /**
     * 
     * @type {ShopperUpdateVaultedShopperRequestPaymentSources}
     * @memberof ShopperUpdateVaultedShopperRequest
     */
