 ...
 * 
 * @export
 * @interface ShopperCreateVaultedShopperRequestPaymentSourcesCreditCardInfoInnerCreditCard
 */
export interface ShopperCreateVaultedShopperRequestPaymentSourcesCreditCardInfoInnerCreditCard {
    /**
     * 
     * @type {number}
     * @memberof ShopperCreateVaultedShopperRequestPaymentSourcesCreditCardInfoInnerCreditCard
     */
