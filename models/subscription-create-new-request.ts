...
import { SubscriptionCreateNewRequestPayerInfo } from './subscription-create-new-request-payer-info';
import { SubscriptionCreateNewRequestPaymentSource } from './subscription-create-new-request-payment-source';

/**
 * 
 * @export
 * @interface SubscriptionCreateNewRequest
 */
export interface SubscriptionCreateNewRequest {
    /**
     * 
     * @type {SubscriptionCreateNewRequestPayerInfo}
     * @memberof SubscriptionCreateNewRequest
     */
    'payerInfo'?: SubscriptionCreateNewRequestPayerInfo;
    /**
     * 
     * @type {SubscriptionCreateNewRequestPaymentSource}
     * @memberof SubscriptionCreateNewRequest
     */
