 ...
 * 
 * @export
 * @interface SubscriptionCreateMerchantManagedSubscriptionRequestPaymentSourceCreditCardInfoCreditCard
 */
export interface SubscriptionCreateMerchantManagedSubscriptionRequestPaymentSourceCreditCardInfoCreditCard {
    /**
     * 
     * @type {number}
     * @memberof SubscriptionCreateMerchantManagedSubscriptionRequestPaymentSourceCreditCardInfoCreditCard
     */
