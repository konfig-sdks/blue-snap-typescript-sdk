...
import { ShopperCreateVaultedShopperRequestPaymentSourcesCreditCardInfoInner } from './shopper-create-vaulted-shopper-request-payment-sources-credit-card-info-inner';

/**
 * 
 * @export
 * @interface ShopperCreateVaultedShopperRequestPaymentSources
 */
export interface ShopperCreateVaultedShopperRequestPaymentSources {
    /**
     * 
     * @type {Array<ShopperCreateVaultedShopperRequestPaymentSourcesCreditCardInfoInner>}
     * @memberof ShopperCreateVaultedShopperRequestPaymentSources
     */
    'creditCardInfo'?: Array<ShopperCreateVaultedShopperRequestPaymentSourcesCreditCardInfoInner>;
}
