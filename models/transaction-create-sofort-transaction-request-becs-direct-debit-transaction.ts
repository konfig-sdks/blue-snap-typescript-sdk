 ...
 * 
 * @export
 * @interface TransactionCreateSofortTransactionRequestBecsDirectDebitTransaction
 */
export interface TransactionCreateSofortTransactionRequestBecsDirectDebitTransaction {
    /**
     * 
     * @type {string}
     * @memberof TransactionCreateSofortTransactionRequestBecsDirectDebitTransaction
     */
    'bsbNumber'?: string;
    /**
     * 
