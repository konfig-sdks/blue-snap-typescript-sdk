...
import { SubscriptionCreateNewRequestPaymentSourceCreditCardInfoCreditCard } from './subscription-create-new-request-payment-source-credit-card-info-credit-card';

/**
 * 
 * @export
 * @interface SubscriptionCreateNewRequestPaymentSourceCreditCardInfo
 */
export interface SubscriptionCreateNewRequestPaymentSourceCreditCardInfo {
    /**
     * 
     * @type {SubscriptionCreateNewRequestPaymentSourceCreditCardInfoCreditCard}
     * @memberof SubscriptionCreateNewRequestPaymentSourceCreditCardInfo
     */
    'creditCard'?: SubscriptionCreateNewRequestPaymentSourceCreditCardInfoCreditCard;
}
