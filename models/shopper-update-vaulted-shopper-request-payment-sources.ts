...
import { ShopperUpdateVaultedShopperRequestPaymentSourcesCreditCardInfoInner } from './shopper-update-vaulted-shopper-request-payment-sources-credit-card-info-inner';

/**
 * 
 * @export
 * @interface ShopperUpdateVaultedShopperRequestPaymentSources
 */
export interface ShopperUpdateVaultedShopperRequestPaymentSources {
    /**
     * 
     * @type {Array<ShopperUpdateVaultedShopperRequestPaymentSourcesCreditCardInfoInner>}
     * @memberof ShopperUpdateVaultedShopperRequestPaymentSources
     */
    'creditCardInfo'?: Array<ShopperUpdateVaultedShopperRequestPaymentSourcesCreditCardInfoInner>;
}
