 ...
 * 
 * @export
 * @interface TransactionInitiateRefundRequestTransactionMetaDataMetaDataInner
 */
export interface TransactionInitiateRefundRequestTransactionMetaDataMetaDataInner {
    /**
     * 
     * @type {string}
     * @memberof TransactionInitiateRefundRequestTransactionMetaDataMetaDataInner
     */
    'metaValue'?: string;
    /**
     * 
